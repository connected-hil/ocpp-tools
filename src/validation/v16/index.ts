/**
 * Generated by scripts/validators-ast.ts */
import { schemas } from "../../schemas";
import { validateOCPPPayload } from "../../validation";
import { type AuthorizeResponseV16, type AuthorizeRequestV16, type BootNotificationResponseV16, type BootNotificationRequestV16, type CancelReservationResponseV16, type CancelReservationRequestV16, type CertificateSignedResponseV16, type CertificateSignedRequestV16, type ChangeAvailabilityResponseV16, type ChangeAvailabilityRequestV16, type ChangeConfigurationResponseV16, type ChangeConfigurationRequestV16, type ClearCacheResponseV16, type ClearCacheRequestV16, type ClearChargingProfileResponseV16, type ClearChargingProfileRequestV16, type DataTransferResponseV16, type DataTransferRequestV16, type DeleteCertificateResponseV16, type DeleteCertificateRequestV16, type DiagnosticsStatusNotificationResponseV16, type DiagnosticsStatusNotificationRequestV16, type ExtendedTriggerMessageResponseV16, type ExtendedTriggerMessageRequestV16, type FirmwareStatusNotificationResponseV16, type FirmwareStatusNotificationRequestV16, type GetCompositeScheduleResponseV16, type GetCompositeScheduleRequestV16, type GetConfigurationResponseV16, type GetConfigurationRequestV16, type GetDiagnosticsResponseV16, type GetDiagnosticsRequestV16, type GetInstalledCertificateIdsResponseV16, type GetInstalledCertificateIdsRequestV16, type GetLocalListVersionResponseV16, type GetLocalListVersionRequestV16, type GetLogResponseV16, type GetLogRequestV16, type HeartbeatResponseV16, type HeartbeatRequestV16, type InstallCertificateResponseV16, type InstallCertificateRequestV16, type LogStatusNotificationResponseV16, type LogStatusNotificationRequestV16, type MeterValuesResponseV16, type MeterValuesRequestV16, type RemoteStartTransactionResponseV16, type RemoteStartTransactionRequestV16, type RemoteStopTransactionResponseV16, type RemoteStopTransactionRequestV16, type ReserveNowResponseV16, type ReserveNowRequestV16, type ResetResponseV16, type ResetRequestV16, type RpcCallErrorV16, type RpcCallResultV16, type RpcCallV16, type SecurityEventNotificationResponseV16, type SecurityEventNotificationRequestV16, type SendLocalListResponseV16, type SendLocalListRequestV16, type SetChargingProfileResponseV16, type SetChargingProfileRequestV16, type SignCertificateResponseV16, type SignCertificateRequestV16, type SignedFirmwareStatusNotificationResponseV16, type SignedFirmwareStatusNotificationRequestV16, type SignedUpdateFirmwareResponseV16, type SignedUpdateFirmwareRequestV16, type StartTransactionResponseV16, type StartTransactionRequestV16, type StatusNotificationResponseV16, type StatusNotificationRequestV16, type StopTransactionResponseV16, type StopTransactionRequestV16, type TriggerMessageResponseV16, type TriggerMessageRequestV16, type UnlockConnectorResponseV16, type UnlockConnectorRequestV16, type UpdateFirmwareResponseV16, type UpdateFirmwareRequestV16 } from "./../../types/v16";
...
/**
 * Validation function for CertificateSignedResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidCertificateSignedResponseV16 = (data: unknown): data is CertificateSignedResponseV16 => validateOCPPPayload(schemas.v16.certificateSignedResponseV16, data);

/**
 * Validation function for CertificateSignedRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidCertificateSignedRequestV16 = (data: unknown): data is CertificateSignedRequestV16 => validateOCPPPayload(schemas.v16.certificateSignedRequestV16, data);
...
/**
 * Validation function for DeleteCertificateResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidDeleteCertificateResponseV16 = (data: unknown): data is DeleteCertificateResponseV16 => validateOCPPPayload(schemas.v16.deleteCertificateResponseV16, data);

/**
 * Validation function for DeleteCertificateRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidDeleteCertificateRequestV16 = (data: unknown): data is DeleteCertificateRequestV16 => validateOCPPPayload(schemas.v16.deleteCertificateRequestV16, data);
...
/**
 * Validation function for ExtendedTriggerMessageResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidExtendedTriggerMessageResponseV16 = (data: unknown): data is ExtendedTriggerMessageResponseV16 => validateOCPPPayload(schemas.v16.extendedTriggerMessageResponseV16, data);

/**
 * Validation function for ExtendedTriggerMessageRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidExtendedTriggerMessageRequestV16 = (data: unknown): data is ExtendedTriggerMessageRequestV16 => validateOCPPPayload(schemas.v16.extendedTriggerMessageRequestV16, data);
...
/**
 * Validation function for GetInstalledCertificateIdsResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidGetInstalledCertificateIdsResponseV16 = (data: unknown): data is GetInstalledCertificateIdsResponseV16 => validateOCPPPayload(schemas.v16.getInstalledCertificateIdsResponseV16, data);

/**
 * Validation function for GetInstalledCertificateIdsRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidGetInstalledCertificateIdsRequestV16 = (data: unknown): data is GetInstalledCertificateIdsRequestV16 => validateOCPPPayload(schemas.v16.getInstalledCertificateIdsRequestV16, data);
...
/**
 * Validation function for GetLogResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidGetLogResponseV16 = (data: unknown): data is GetLogResponseV16 => validateOCPPPayload(schemas.v16.getLogResponseV16, data);

/**
 * Validation function for GetLogRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidGetLogRequestV16 = (data: unknown): data is GetLogRequestV16 => validateOCPPPayload(schemas.v16.getLogRequestV16, data);
...
/**
 * Validation function for InstallCertificateResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidInstallCertificateResponseV16 = (data: unknown): data is InstallCertificateResponseV16 => validateOCPPPayload(schemas.v16.installCertificateResponseV16, data);

/**
 * Validation function for InstallCertificateRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidInstallCertificateRequestV16 = (data: unknown): data is InstallCertificateRequestV16 => validateOCPPPayload(schemas.v16.installCertificateRequestV16, data);

/**
 * Validation function for LogStatusNotificationResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidLogStatusNotificationResponseV16 = (data: unknown): data is LogStatusNotificationResponseV16 => validateOCPPPayload(schemas.v16.logStatusNotificationResponseV16, data);

/**
 * Validation function for LogStatusNotificationRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidLogStatusNotificationRequestV16 = (data: unknown): data is LogStatusNotificationRequestV16 => validateOCPPPayload(schemas.v16.logStatusNotificationRequestV16, data);
...
/**
 * Validation function for SecurityEventNotificationResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidSecurityEventNotificationResponseV16 = (data: unknown): data is SecurityEventNotificationResponseV16 => validateOCPPPayload(schemas.v16.securityEventNotificationResponseV16, data);

/**
 * Validation function for SecurityEventNotificationRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidSecurityEventNotificationRequestV16 = (data: unknown): data is SecurityEventNotificationRequestV16 => validateOCPPPayload(schemas.v16.securityEventNotificationRequestV16, data);
...
/**
 * Validation function for SignCertificateResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidSignCertificateResponseV16 = (data: unknown): data is SignCertificateResponseV16 => validateOCPPPayload(schemas.v16.signCertificateResponseV16, data);

/**
 * Validation function for SignCertificateRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidSignCertificateRequestV16 = (data: unknown): data is SignCertificateRequestV16 => validateOCPPPayload(schemas.v16.signCertificateRequestV16, data);

/**
 * Validation function for SignedFirmwareStatusNotificationResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidSignedFirmwareStatusNotificationResponseV16 = (data: unknown): data is SignedFirmwareStatusNotificationResponseV16 => validateOCPPPayload(schemas.v16.signedFirmwareStatusNotificationResponseV16, data);

/**
 * Validation function for SignedFirmwareStatusNotificationRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidSignedFirmwareStatusNotificationRequestV16 = (data: unknown): data is SignedFirmwareStatusNotificationRequestV16 => validateOCPPPayload(schemas.v16.signedFirmwareStatusNotificationRequestV16, data);

/**
 * Validation function for SignedUpdateFirmwareResponseV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidSignedUpdateFirmwareResponseV16 = (data: unknown): data is SignedUpdateFirmwareResponseV16 => validateOCPPPayload(schemas.v16.signedUpdateFirmwareResponseV16, data);

/**
 * Validation function for SignedUpdateFirmwareRequestV16 using JSON included schema.
 *  @param { unknown } data JSON decoded payload to validate
 *  @returns { boolean } true if payload is valid against schema, false otherwise
 *  */
export const isValidSignedUpdateFirmwareRequestV16 = (data: unknown): data is SignedUpdateFirmwareRequestV16 => validateOCPPPayload(schemas.v16.signedUpdateFirmwareRequestV16, data);
...
export const actionValidatorV16: {
    ...
    "SignedFirmwareStatusNotification": isValidSignedFirmwareStatusNotificationRequestV16,
